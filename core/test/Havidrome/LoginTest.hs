  ...
  Group
    ...
    ,
      ...
      , example do
          ...
          map (`value` blank) fields === ["", "", ""]
      )
    ,
      ( "the three fields are moved through in the order they are asked in"
      , example do
          map ahead fields === [Username, Password, ServerUrl]
          map back fields === [Password, ServerUrl, Username]
      )
    ,
    ...
    ,
      ...
      , example (map labelled fields === ["Server URL  ", "Username    ", "Password    "])
      )
    ]
