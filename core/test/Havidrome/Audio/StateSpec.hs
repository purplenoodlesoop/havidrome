...
holding :: Spec
holding = describe "pausing and resuming" $ do
...
reaching :: Spec
reaching = describe "the position the audio has reached" $ do
...
finishing :: Spec
finishing = describe "finishing" $ do
  it "is reported, once" $
